...
from model_adapter import AdapterGNN, GNN_graphpred_PET
...
def main():
    # Training settings
    parser = argparse.ArgumentParser(description='PyTorch implementation of transfer learning of graph neural networks')
    ...
    #set up model
    model = GNN_graphpred_PET(args.num_layer, args.emb_dim, num_tasks, JK = args.JK, drop_ratio = args.dropout_ratio, graph_pooling = args.graph_pooling)
    model.to(device)
    ...
    for epoch in range(1, args.epochs+1):
        ...
        print("")
    with open('outputs/adapt_result.log', 'a+') as f:
